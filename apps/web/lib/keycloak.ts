...
export function getKeycloakConfig() {
  ...
  return {
    issuer,
    baseUrl,
    clientId: requireEnv('KEYCLOAK_CLIENT_ID', 'noro-guru-web'),
    clientSecret: requireEnv('KEYCLOAK_CLIENT_SECRET', 'noro-guru-web-secret'),
    cookieSecret: requireEnv(
      'KEYCLOAK_COOKIE_SECRET',
      'noro-guru-web-keycloak-cookie-secret-32bytes!',
    ),
