...
import { emitirCobranca, PaymentProvider } from '@/app/pedidos/pedidos-actions';
        ...
        {!hasActiveCobranca && (
            <form onSubmit={handleSubmit} className="space-y-4 border-b pb-4 mb-4">
                ...
                <div className="flex justify-between pt-2">
                    <p className="text-sm text-gray-500">Valor: <span className="font-semibold text-gray-800">{formatCurrency(valorTotal)}</span></p>
