...
import type { ConfiguracaoSistema, ConfiguracaoUsuario } from '@/app/configuracoes/config-actions';
import type { EmpresaDados } from '@/app/configuracoes/empresa-actions'; // NOVO: Importa o tipo
