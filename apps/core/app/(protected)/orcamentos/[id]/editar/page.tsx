...
import { getOrcamentoById } from '@/app/orcamentos/orcamentos-actions'; 
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Editar Orçamento ${result.data.numero || result.data.titulo} | Noro`,
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Modifique a proposta e os itens do orçamento {orcamento.numero || orcamento.titulo}.</p>
      </div>
