...
// TODO: Descomentar quando noro_pedidos for adicionado ao types/supabase.ts
// import { Database } from '@/types/supabase';
// export type Pedido = Database['public']['Tables']['noro_pedidos']['Row'];

/**
 * Função de busca de pedidos no Supabase.
 * @returns Array de pedidos ou um array vazio em caso de erro.
 */
async function fetchPedidos(): Promise<any[]> {
