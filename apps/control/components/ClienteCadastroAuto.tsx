...
export default function ClienteCadastroAuto() {
  ...
  return (
    <form className="space-y-4 p-4 max-w-lg mx-auto">
      <h2 className="text-xl font-bold mb-2">Cadastro de Cliente com Auto-preenchimento</h2>
      <div>
        <label>CNPJ:</label>
      ...
      <button type="submit" className="btn-primary mt-4">Salvar Cliente</button>
    </form>
  );
}
