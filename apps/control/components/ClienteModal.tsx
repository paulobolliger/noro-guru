...
export default function ClienteModal({ isOpen, onClose, cliente }: ClienteModalProps) {
  ...
  return (
    ...
    >
    <div
      className="surface-card border border-default rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="sticky top-0 surface-header border-b border-default border-default border-default px-8 py-6 flex items-center justify-between">
          <div>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full p-3 border border-default rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-3 border border-default rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>
          </div>
          ...
          {/* Actions */}
          <div className="flex gap-4 mt-8 pt-6 border-t border-default">
            <button
              type="button"
              onClick={onClose}
              disabled={isPending}
