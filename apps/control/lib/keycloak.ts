...
export function getKeycloakConfig() {
  ...
  return {
    issuer,
    baseUrl,
    clientId: requireEnv('KEYCLOAK_CLIENT_ID', 'noro-guru-control'),
    clientSecret: requireEnv('KEYCLOAK_CLIENT_SECRET', 'noro-guru-control-secret'),
    cookieSecret: requireEnv(
      'KEYCLOAK_COOKIE_SECRET',
      'noro-guru-control-keycloak-cookie-secret-32bytes!',
    ),
