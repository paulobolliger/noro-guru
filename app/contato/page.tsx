...
// Em projetos reais, isto seria movido para um `layout.tsx` ou `head.tsx` se a página fosse estática.
// const metadata: Metadata = {
//   title: 'Fale Connosco - Nomade Guru',
//   description: 'Entre em contacto com a Nomade Guru para tirar dúvidas, dar sugestões ou planear a sua viagem.',
// };
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-5">
            <div className="grid lg:grid-cols-5 gap-12">
              ...
              {/* Formulário */}
              <div className="lg:col-span-3 rounded-2xl bg-secondary-dark p-8 shadow-lg">
              ...
              <div className="lg:col-span-2">
                <div className="rounded-2xl bg-secondary-dark p-8 shadow-lg h-full">
                  <h2 className="text-2xl font-bold mb-6">Informações de Conta to</h2>
