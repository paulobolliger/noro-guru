revoke select on table "cp"."lead_activity" from "anon";

revoke select on table "cp"."lead_activity" from "authenticated";

revoke select on table "cp"."lead_activity" from "service_role";

revoke select on table "cp"."lead_stages" from "anon";

revoke select on table "cp"."lead_stages" from "authenticated";

revoke select on table "cp"."lead_stages" from "service_role";

revoke select on table "cp"."webhook_logs" from "anon";

revoke select on table "cp"."webhook_logs" from "authenticated";

revoke select on table "cp"."webhook_logs" from "service_role";
