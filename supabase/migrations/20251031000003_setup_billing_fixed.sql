-- Adiciona coluna admin_user_ids à tabela cp.tenants se ainda não existir
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 
        ...
        ADD COLUMN admin_user_ids uuid[] DEFAULT '{}'::uuid[];
    END IF;
END $$;

-- Criamos o schema billing
...
CREATE TABLE IF NOT EXISTS billing.subscriptions (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id uuid NOT NULL REFERENCES cp.tenants(id),
