...
-- Ãndices para contas bancÃ¡rias
CREATE INDEX IF NOT EXISTS idx_fin_contas_bancarias_tenant ON public.fin_contas_bancarias(tenant_id);
CREATE INDEX IF NOT EXISTS idx_fin_contas_bancarias_banco ON public.fin_contas_bancarias(banco_codigo);
CREATE INDEX IF NOT EXISTS idx_fin_contas_bancarias_ativo ON public.fin_contas_bancarias(ativo);
CREATE INDEX IF NOT EXISTS idx_fin_contas_bancarias_openfinance ON public.fin_contas_bancarias(openfinance_habilitado) WHERE openfinance_habilitado = true;
